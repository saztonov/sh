...
- Для получения файлов/вложений: сначала get_assignment_details (получишь attachments с id), затем get_file_info(attachment_id) для каждого файла — он вернёт download_url со ссылкой для скачивания
