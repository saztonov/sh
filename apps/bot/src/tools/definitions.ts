...
export const agentTools = {
  get_assignments: tool({
    description:
      '[ШКОЛА] Получить список школьных домашних заданий с вложениями. Каждое задание содержит массив attachments[] с download_url для скачивания файлов — всегда показывай эти ссылки пользователю. Фильтры: период (today/tomorrow/week), дата, предмет, статус выполнения.',
    parameters: z.object({
